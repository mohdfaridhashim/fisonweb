		...
		return ((x < y) ?  1 : ((x > y) ? -1 : 0));
			...
			$(document).ready(function() {
				$('#counter').dataTable({"sPaginationType": "full_numbers","bLengthChange": false,"bInfo": false,"bPaginate":false,"aaSorting": [[ "4", "desc" ]],"bSort": true,"sScrollY": "450px"});
			} );
...
function sorting(value)
{
			...
			//var list5= document.getElementById("counter").tBodies[0].rows[c];
			...
			/*color2 last,chg,buy,sell,high,low
			color3[0] = list5.getElementsByTagName("td")[3].style.color;
			color3[1] = list5.getElementsByTagName("td")[4].style.color;
			color3[2] = list5.getElementsByTagName("td")[6].style.color;
			color3[3] = list5.getElementsByTagName("td")[7].style.color;
			color3[4] = list5.getElementsByTagName("td")[9].style.color;
			color3[5] = list5.getElementsByTagName("td")[10].style.color;
			*/
			//sorting
			var c = parseInt(data[4]);
			var d = parseInt(list4.getElementsByTagName("td")[4].innerHTML);
			//var g = parseInt(list5.getElementsByTagName("td")[4].innerHTML);
			var e = parseInt(c - d);
			//var f = parseInt(c - g);
			if (e < 0)
			{
			...
			list3.getElementsByTagName("td")[3].style.color = color[0];
			...
			list3.getElementsByTagName("td")[4].style.color = color[1];
			...
			list3.getElementsByTagName("td")[6].style.color = color[2];
			list3.getElementsByTagName("td")[7].innerHTML=list4.getElementsByTagName("td")[7].innerHTML;
			list3.getElementsByTagName("td")[7].style.color = color[3];
			...
			list3.getElementsByTagName("td")[9].style.color = color[4];
			list3.getElementsByTagName("td")[10].innerHTML=list4.getElementsByTagName("td")[10].innerHTML;
			list3.getElementsByTagName("td")[10].style.color = color[5];
