...
<table border="0"  width="120px" cellspacing="0" cellpadding="0" id="score">
  <tr>
    <td id="FMPcontent">PREVIOUS</td>
    <td bgcolor="#CC0000" id="FMPvalue"><span id="prev"><?php echo $fbmklci[2]; ?></span></td>
  </tr>
  <tr>
    <td id="FMPcontent">CHANGE</td>
    <td bgcolor="#0066CC" id="FMPvalue"><span id="chg"><?php echo round($fbmklci[4],4); ?></span></td>
  </tr>
  <tr>
    <td id="FMPcontent">UP</td>
    <td bgcolor="#0066CC" id="FMPvalue"><span id="up"><?php echo $scoreboard[2]; ?></span></td>
  </tr>
  <tr>
    <td id="FMPcontent">DOWN</td>
    <td bgcolor="#FF9900" id="FMPvalue"><span id="down"><?php echo $scoreboard[3]; ?></span></td>
  </tr>
  <tr>
    <td id="FMPcontent">TVOL</td>
    <td bgcolor="#FF9900" id="FMPvalue"><span id="tvol"><?php echo $scoreboard[1]; ?></span></td>
  </tr>
  <tr>
    <td id="FMPcontent">VALUE</td>
    <td bgcolor="#009900" id="FMPvalue"><span id="tval"><?php echo $scoreboard[0]; ?></span></td>
  </tr>
  <tr>
    <td id="FMPcontent">FBMKLCI</td>
    <td bgcolor="#009900" id="FMPvalue"><span id="ci"><?php echo $fbmklci[3]; ?></span></td>
  </tr>
</table>