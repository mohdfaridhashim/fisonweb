...
<div style="width:1200px; margin:0px auto; background-color:#FFF;">
  <div id="title_bar">
    ...
    <a href="index.php?watch=gain" id="title_link" target="stocktable">TOP Gainers</a>
    <a href="index.php?watch=loser" id="title_link" target="stocktable">TOP Losers</a>
...
<DIV id="profile_info">
 Name:<br/>
<strong><?php echo $userdata[3];?></strong><br/>
...
<div id="sidebar">
<div id="FMPtitle">SCOREBOARD<br/></div>
