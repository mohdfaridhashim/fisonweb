...
[
 <?php
  ...
  //echo $time[1]."\r\n";
  //echo strtotime($tarikh[0]."-".$tarikh[1]."-".$tarikh[2])."\r\n";
  ...
  ?>
  [<?php /*echo $time[0]*/ echo $milliseconds; ?>, <?php echo $views[0][0][1]; ?>, <?php echo $views[0][$i][6]; ?>, <?php echo $views[0][$i][7]; ?>, <?php echo $views[0][$i][11]; ?>, <?php echo $views[0][$i][8]; ?>],
  <?php 
  }
  else
  { ?>
