	...
	color:#ffcc00;
		...
		return ((x < y) ?  1 : ((x > y) ? -1 : 0));
			...
			$(document).ready(function() {
				$('#counter').dataTable({"sPaginationType": "full_numbers","bLengthChange": false,"bInfo": false,"bPaginate": false,"aaSorting": [[ "4", "asc" ]],"bSort": false,"sScrollY": "400px"
...
<table width="100%" border="0">
  <tr>
    <td align="Left"><h3>TOP LOSERS</h3></td>
  </tr>
</table>
 ...
 <tbody >
  <?php for($i = 0; $i < $views[1] ; $i++) { if($views[0][$i][19] != "1"){?>
    <tr >
      ...
      <td class="center"><a href='#' onclick="addtofav('<?php echo $views[0][$i][1];  ?>')"><img src="views/media/images/addButton.gif" alt="Add"/></a></td>
    </tr>
    <?php } } ?>
  </tbody>
